...
!function (e) {
    ...
    s.version = "2.2.3", s.dependencies = {zrender: "2.0.9"}, s.init = function (t, n) {
        var a = e("zrender");
        ...
        _init: function () {
            ...
            function s() {
                if (X._zr) {
                    ...
                    for (var e = 0, t = L.length; t > e; e++)L[e].motionlessOnce = h.addDataAnimation && L[e].addDataAnimation;
                    X._messageCenter.dispatch(a.EVENT.REFRESH, null, {option: h}, X)
                }
            }

            for (var l = e instanceof Array ? e : [[e, t, i, n, r]], h = this.getOption(), d = this._optionRestore, c = 0, m = l.length; m > c; c++) {
                e = l[c][0], t = l[c][1], i = l[c][2], n = l[c][3], r = l[c][4];
                var p = d.series[e], u = i ? "unshift" : "push", V = i ? "pop" : "shift";
                if (p) {
                    var U = p.data, g = h.series[e].data;
                    if (U[u](t), g[u](t), n || (U[V](), t = g[V]()), null != r) {
                        var f, y;
                        if (p.type === a.CHART_TYPE_PIE && (f = d.legend) && (y = f.data)) {
                            var b = h.legend.data;
                            if (y[u](r), b[u](r), !n) {
                                var _ = o.indexOf(y, t.name);
                                -1 != _ && y.splice(_, 1), _ = o.indexOf(b, t.name), -1 != _ && b.splice(_, 1)
                            }
                        } else if (null != d.xAxis && null != d.yAxis) {
                            var x, k, v = p.xAxisIndex || 0;
                            (null == d.xAxis[v].type || "category" === d.xAxis[v].type) && (x = d.xAxis[v].data, k = h.xAxis[v].data, x[u](r), k[u](r), n || (x[V](), k[V]())), v = p.yAxisIndex || 0, "category" === d.yAxis[v].type && (x = d.yAxis[v].data, k = h.yAxis[v].data, x[u](r), k[u](r), n || (x[V](), k[V]()))
                        }
                    }
            ...
            for (var L = this._chartList, w = 0, W = function () {
                w--, 0 === w && s()
            }, c = 0, m = L.length; m > c; c++)h.addDataAnimation && L[c].addDataAnimation && (w++, L[c].addDataAnimation(l, W));
            this.component.dataZoom && this.component.dataZoom.syncOption(h), this._option = h;
            var X = this;
            return h.addDataAnimation || setTimeout(s, 0), this
    ...
    d.version = "2.0.9", d.init = function (e) {
        var t = new c(a(), e);
        return h[t.id] = t, t
    ...
    var e = {
        EVENT: {
            ...
            DROP: "drop",
            touchClickDelay: 300
        }, catchBrushException: !1, debugMode: 0, devicePixelRatio: Math.max(window.devicePixelRatio || 1, 1)
    };
    return e
    ...
    return t.prototype = {
        type: a.CHART_TYPE_ISLAND, _combine: function (t, i) {
            ...
            var t = o.get(e, "name"), i = o.get(e, "value"), a = null != o.get(e, "series") ? o.get(e, "series").name : "", r = this.getFont(this.option.island.textStyle), s = {
            ...
            "#fff" === s.style.color && (s.style.color = e.style.strokeColor), this.setCalculable(s), s.dragEnableTime = 0, o.pack(s, {name: a}, -1, i, -1, t), s = new n(s), this.shapeList.push(s), this.zr.addShape(s)
        }, del: function (e) {
    ...
    return t.prototype = {
        type: s.COMPONENT_TYPE_TIMELINE, _buildShape: function () {
            ...
            return this._ctrPlayShape && "playing" != this._ctrPlayShape.style.status && (this._ctrPlayShape.style.status = "playing", this.zr.modShape(this._ctrPlayShape.id), this.zr.refreshNextFrame()), this.timelineOption.autoPlay = null != t ? t : !0,
            this.timelineOption.autoPlay || clearTimeout(this.playTicket), this.currentIndex = null != e ? e : this.currentIndex + 1, this.currentIndex >= this.timelineOption.data.length && (this.currentIndex = 0), this._onFrame(), this.currentIndex
        }, stop: function () {
    ...
    var o = e("./config"), r = e("./tool/env"), s = e("./tool/event"), l = e("./tool/util"), h = e("./tool/vector"), d = e("./tool/matrix"), c = o.EVENT, m = e("./mixin/Eventful"), p = ["resize", "click", "dblclick", "mousewheel", "mousemove", "mouseout", "mouseup", "mousedown", "touchstart", "touchend", "touchmove"], u = {
        resize: function (e) {
            ...
            e = this._zrenderEventFixed(e);
            var t = e.wheelDelta || -e.detail, i = t > 0 ? 1.1 : 1 / 1.1, n = !1, a = this._mouseX, o = this._mouseY;
            ...
            if (!this.painter.isLoading()) {
                ...
                var n = "default";
                if (this._draggingTarget)this.storage.drift(this._draggingTarget.id, t, i), this._draggingTarget.modSelf(), this.storage.addHover(this._draggingTarget), this._clickThreshold++; else if (this._isMouseDown) {
                    var a = !1;
            ...
            return this._clickThreshold = 0, 2 == this._lastDownButton ? (this._lastDownButton = e.button, void(this._mouseDownTarget = null)) : (this._lastMouseDownMoment = new Date, e = this._zrenderEventFixed(e), this._isMouseDown = 1, this._mouseDownTarget = this._lastHover, this._dispatchAgency(this._lastHover, c.MOUSEDOWN, e), void(this._lastDownButton = e.button))
        }, mouseup: function (e) {
            e = this._zrenderEventFixed(e), this.root.style.cursor = "default", this._isMouseDown = 0, this._mouseDownTarget = null, this._dispatchAgency(this._lastHover, c.MOUSEUP, e), this._processDrop(e), this._processDragEnd(e)
    ...
    }, l.merge(V.prototype, m.prototype, !0), V
    ...
    var a = e("./config"), o = e("./tool/util"), r = e("./tool/log"), s = e("./loadingEffect/Base"), l = e("./Layer"), h = function (e, i) {
        ...
        var n = document.createElement("div");
        this._domRoot = n, n.style.position = "relative", n.style.overflow = "hidden", n.style.width = this._width + "px", n.style.height = this._height + "px", e.appendChild(n), this._layers = {}, this._zlevelList = [], this._layerConfig = {}, this._loadingEffect = new s({}), this.shapeToImage = this._createShapeToImageProcessor(), this._bgDom = document.createElement("div"), this._bgDom.style.cssText = ["position:absolute;left:0px;top:0px;width:", this._width, "px;height:", this._height + "px;", "-webkit-user-select:none;user-select;none;", "-webkit-touch-callout:none;"].join(""), this._bgDom.setAttribute("data-zr-dom-id", "bg"), n.appendChild(this._bgDom), this._bgDom.onselectstart = t;
        var a = new l("_zrender_hover_", this);
        this._layers.hover = a, n.appendChild(a.dom), a.initContext(), a.dom.onselectstart = t, a.dom.style["-webkit-user-select"] = "none", a.dom.style["user-select"] = "none", a.dom.style["-webkit-touch-callout"] = "none", this.refreshNextFrame = null
    };
    ...
    var n = e("./mixin/Transformable"), a = e("./tool/util"), o = window.G_vmlCanvasManager, r = e("./config"), s = function (e, a) {
        this.id = e, this.dom = i(e, "canvas", a), this.dom.onselectstart = t, this.dom.style["-webkit-user-select"] = "none", this.dom.style["user-select"] = "none", this.dom.style["-webkit-touch-callout"] = "none", this.dom.style["-webkit-tap-highlight-color"] = "rgba(0,0,0,0)", o && o.initElement(this.dom), this.domBack = null, this.ctxBack = null, this.painter = a, this.unusedCount = 0, this.config = null, this.dirty = !0, this.elCount = 0, this.clearColor = 0, this.motionBlur = !1, this.lastFrameAlpha = .7, this.zoomable = !1, this.panable = !1, this.maxZoom = 1 / 0, this.minZoom = 0, n.call(this)
    };
    ...
    return i.prototype = {
        setCalculable: function (e) {
            ...
            if (c) {
                ...
                if (p) {
                    U.merge(m.style, p.style), U.merge(m.highlightStyle = {}, p.highlightStyle), m.style.brushType = "stroke", m.zlevel = this.getZlevelBase(), m.z = this.getZBase() + 1, m.hoverable = !1;
            ...
            if (!e && this.clearEffectShape(), e = e || this.shapeList, null != e) {
                ...
                this.canvasSupported && this.zr.modLayer(t, {motionBlur: !0, lastFrameAlpha: .95});
