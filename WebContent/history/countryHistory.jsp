...
<body style="zoom: 1">
    ...
    <div id="wrapper">
    	...
    	<!-- main body start -->
        <div class="jd_main" style="min-height: 750px">
            ...
            <div class="jd_main_content" style="position: relative">
                <span id="historyBand">History of Country Content</span>
                ...
                <%
                    ...
                    for(Document doc : docsArr) {
                    	...
                    	publish_place = doc.getString("publish_place");
                    	pub_date = doc.getString("pub_date");
                ...
                <div class="company">
                    ...
                    <p>
                        <storng class="company-tag">Publish Place</storng>&nbsp;<%out.println(publish_place);%>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <storng class="company-tag">Publish Date</storng>&nbsp;<%out.println(pub_date);%>
                    </p>
                    <p>
                        <storng class="company-tag">Subjects</storng>&nbsp;
