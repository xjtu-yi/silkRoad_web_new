        ...
        <div class="head">
            ...
            <div class="head_d">
                <div id="smoothmenu1" class="ddsmoothmenu">                    
	    			<ul>
	    			  <li><a href="http://ikcest.xjtu.edu.cn/index.jsp">Home</a></li>
	    			  <li><a href="http://ikcest.xjtu.edu.cn/list.jsp?urltype=tree.TreeTempUrl&wbtreeid=1297">News</a></li>
	    			  <li><a href="http://ikcest.xjtu.edu.cn/Symposium.jsp?urltype=tree.TreeTempUrl&wbtreeid=1294">Symposium</a></li>
	    			  <li><a href="http://ikcest.xjtu.edu.cn/uansr_dt_list.jsp?urltype=tree.TreeTempUrl&wbtreeid=1014">UASR</a></li>
	    			  <li><a href="http://ikcest.xjtu.edu.cn/page.jsp?urltype=tree.TreeTempUrl&wbtreeid=1298">About US</a></li>
	    			</ul>                
                </div>
                <script type="text/javascript">
                    ddsmoothmenu.init({
