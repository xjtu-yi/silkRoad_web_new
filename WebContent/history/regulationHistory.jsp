...
<head>
	...
	<title>Personalized Services-IKCEST</title>
...
<body style="zoom: 1">
    ...
    <div id="wrapper">
        ...
        <div class="head">
                ...
                <div class="topbar_con">
                    <div class="topbar_left fl">
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                <td>
                                    <a href="http://www.ikcest.org/index.htm" target="_blank">&nbsp;Welcome to the IKCEST</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
            ...
            <div class="head_d">
                <div id="smoothmenu1" class="ddsmoothmenu">                    
	    			<ul>
	    			  <li><a href="http://silkroadst.ikcest.org/index.jsp">Home</a></li>
	    			  <li><a href="http://silkroadst.ikcest.org/list.jsp?urltype=tree.TreeTempUrl&wbtreeid=1297">News</a></li>
	    			  <li><a href="http://silkroadst.ikcest.org/Symposium.jsp?urltype=tree.TreeTempUrl&wbtreeid=1294">Symposium</a></li>
	    			  <li><a href="http://silkroadst.ikcest.org/uansr_dt_list.jsp?urltype=tree.TreeTempUrl&wbtreeid=1014">UASR</a></li>
	    			  <li><a href="http://silkroadst.ikcest.org/page.jsp?urltype=tree.TreeTempUrl&wbtreeid=1298">About US</a></li>
	    			</ul>                
                </div>
                <script type="text/javascript">
                    ddsmoothmenu.init({
    	...
    	<!-- main body start -->
        <div class="jd_main" style="min-height: 1000px">
            ...
            <div class="jd_main_content" style="position: relative">
                <span id="historyBand">History of IEEE</span>
                ...
                <%
                    ...
                    String url = null;
                    String title = null;
                    String summary = null; // "abstract" in MongoDB
                    String scope = null;
                    String purpose = null;
                    String date_publication = null;
                    ...
                    for(Document doc : docsArr) {
                    	...
                    	summary = doc.getString("abstract");
                    	scope = doc.getString("scope");
                    	purpose = doc.getString("purpose");
                    	date_publication = doc.getString("date_publication");
                    	full_text = doc.getString("full_text");
                %>
                <div class="company">
                    <a href="<%out.println(url);%>">
                        <strong class="companyName"><%out.println(title);%></strong>
                    </a>
                    <p class="company-tag">Abstract</p>
                    <p style="height:35px; overflow:hidden;"><%out.println(summary);%></p>
                    <p>
                        <storng class="company-tag">Publication Date</storng>&nbsp;<%out.println(date_publication);%>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <storng class="company-tag">Doi</storng>&nbsp;<%out.println(doi);%>
                    </p>
                    <p class="company-tag">Full text URL</p>
                    <p><%out.println(full_text);%></p>
                    <hr class="split">
                </div>
                <div class="times">
                    <% out.println(times); %>
