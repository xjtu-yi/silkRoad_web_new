...
<body style="zoom: 1">
    ...
    <div id="wrapper">
    	...
    	<!-- main body start -->
        <div class="jd_main" style="min-height: 900px">
            ...
            <div class="jd_main_content" style="position: relative">
                <span id="historyBand">History of History and Culture</span>
                ...
                <%
                    ...
                    for(Document doc : docsArr) {
                    	...
                    	title = doc.getString("titile");
                    	year = doc.getString("year");
                    	url = doc.getString("url");
                    	img_url = doc.getString("img_url");
                    	summary = doc.getString("summary");
                    	nation = doc.getString("nation");
                %>
                <div class="uebook">
	                <div class="uebook_img">
	                    <img src="<%out.println(img_url);%>" style="width:90px;height:120px">
	                </div>
	                
	                <div class="uebook_content">
	                    ...
	                    <p>
	                        <storng class="company-tag">Year</storng>&nbsp;<%out.println(year);%>
	                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                        <storng class="company-tag">Nation</storng>&nbsp;<%out.println(nation);%>
	                    </p>
	                    <p><storng class="company-tag">Author</storng>&nbsp;<%out.println(author);%></p>
	                </div>
	                
	                <div class="uebook_number">
	                    <% out.println(times); %>
	                </div>
                </div>
